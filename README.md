# The RPN Calculator!
The Reverse Polish Notation (RPN) Calculator is a calcuator in which operators follow their operands, and this is my simple CLI app implementing that specification.
...
## Running the project
To run in visual studio, clone the repo, set the RPN.CommandLine.UI project as your startup project, and hit the run button 
...
Alternatively you can use the .NET CLI and run the following in a terminal in the rpn_calculator solution folder:
